...
/**
 * @summary Get per-project progress breakdown
 */
export const getProjectProgress = async ( options?: RequestInit): Promise<ProjectProgress[]> => {
...
export const getGetProjectProgressQueryOptions = <TData = Awaited<ReturnType<typeof getProjectProgress>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getProjectProgress>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetProjectProgressQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getProjectProgress>>> = ({ signal }) => getProjectProgress({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getProjectProgress>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useGetProjectProgress<TData = Awaited<ReturnType<typeof getProjectProgress>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getProjectProgress>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
