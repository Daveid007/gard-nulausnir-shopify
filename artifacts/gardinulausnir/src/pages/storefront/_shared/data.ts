...
export const categories = ["Allt", "Myrkvunargardínur", "Rúllugardínur", "Lóðréttar vefgardínur", "Sheer Shades", "Fiðrildagardínur", "Ramma rúllugardínur", "Ramma flugnanet og myrkvunargardínur", "Flugnanet og rammar"];