...
const categoryLinks = [
  ...
  ["Hurðagardínur og flugnanet", collectionHref("thedour-doors")],
] as const;

export function Header({ cartCount = 0, categoryNav = false, onCartClick, showCart = true, businessContext }: { cartCount?: number; categoryNav?: boolean; onCartClick?: () => void; showCart?: boolean; businessContext?: string }) {
