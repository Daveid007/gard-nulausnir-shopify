...
import { CASSETTE_RAIL_COLORS, MOTORIZED_RAIL_COLORS, HONEYCOMB_BOTTOM_RAIL_COLORS, HOLDER_COLORS } from "@/assets/railImages";
...
export default function Honeycomb25Calculator() {
