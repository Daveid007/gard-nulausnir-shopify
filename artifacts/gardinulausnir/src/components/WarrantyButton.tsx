  ...
  return (
    <Dialog>
      ...
      <DialogContent className="w-[calc(100%-2rem)] max-w-lg border-[#ccd9df] bg-[#f7f9fa] p-6 text-[#24313b]">
        ...
        <a className="w-fit text-sm text-[#435f79] underline underline-offset-4" href="mailto:sala@gardinulausnir.is?subject=Spurning%20um%20%C3%A1byrg%C3%B0">Spyrja um ábyrgð</a>
        <DialogClose asChild>
