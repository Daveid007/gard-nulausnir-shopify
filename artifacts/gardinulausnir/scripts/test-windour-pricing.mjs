...
assert.match(wizardSource, /DUO er tveggja flata kerfi\. Það er ekki tvöföld opnun/);
assert.match(wizardSource, /selection\.duoPanelChoices\?\.join\("\s*\+\s*"\)/, "DUO summary must derive its label from selected panels");
